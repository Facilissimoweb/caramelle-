        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 shrink-0 bg-[#a3e635]/10 border border-[#a3e635]/30 text-[#a3e635] flex items-center justify-center rounded-none mt-0.5">
              ...
              <div className="space-y-1">
                <h4 className="font-display font-bold text-[#F8F7F4] flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-mono border border-[#a3e635]/40 text-[#a3e635] px-1.5 py-0.5 uppercase tracking-wide">
            ...
            {!isExpanding && (
              <div className="flex flex-wrap gap-2 shrink-0 w-full md:w-auto md:justify-end">
                <button
                  ...
                  className="px-4 py-2 text-xs font-mono font-bold uppercase tracking-wider text-[#F8F7F4]/60 hover:text-[#a3e635] border border-[rgba(248,247,244,0.1)] hover:border-[#a3e635] transition-all cursor-pointer flex items-center gap-1.5"
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#a3e635] text-[#111113] text-xs font-mono font-bold uppercase tracking-widest hover:bg-transparent hover:text-[#a3e635] border border-[#a3e635] transition-all cursor-pointer"
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-[#111113] border border-[rgba(248,247,244,0.06)] flex flex-col justify-between gap-3">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <span className="text-[10px] font-mono text-[#a3e635] font-bold uppercase">
                  ...
                  <div className={`p-4 border transition-all flex flex-col justify-between gap-3 ${
                    prefs.ga4 ? "bg-[#111113] border-[#a3e635]/30" : "bg-[#111113] border-[rgba(248,247,244,0.06)]"
                  }`}>
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#F8F7F4]/90 uppercase">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <button
                        ...
                        className={`text-[10px] font-mono font-bold uppercase tracking-wider px-2 py-1 transition-all cursor-pointer ${
                          prefs.ga4 ? "text-[#a3e635]" : "text-[#F8F7F4]/50 hover:text-[#F8F7F4]"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`w-12 h-6 border transition-all relative flex items-center px-0.5 cursor-pointer ${
                          prefs.ga4 ? "border-[#a3e635] bg-[#a3e635]/10" : "border-[rgba(248,247,244,0.15)] bg-white/5"
                        }`}
                        id="cookie-toggle-ga4"
                      >
                        <span className={`w-4 h-4 bg-[#F8F7F4] transition-all block ${
                          prefs.ga4 ? "translate-x-6 bg-[#a3e635]" : "translate-x-0 bg-gray-500"
                        }`} />
                      </button>
                    </div>
                  </div>
                  ...
                  <div className={`p-4 border transition-all flex flex-col justify-between gap-3 ${
                    prefs.metaPixel ? "bg-[#111113] border-[#a3e635]/30" : "bg-[#111113] border-[rgba(248,247,244,0.06)]"
                  }`}>
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#F8F7F4]/90 uppercase">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <button
                        ...
                        className={`text-[10px] font-mono font-bold uppercase tracking-wider px-2 py-1 transition-all cursor-pointer ${
                          prefs.metaPixel ? "text-[#a3e635]" : "text-[#F8F7F4]/50 hover:text-[#F8F7F4]"
                        }`}
                      >
                      ...
                      <button
                        onClick={() => togglePref("metaPixel")}
                        className={`w-12 h-6 border transition-all relative flex items-center px-0.5 cursor-pointer ${
                          prefs.metaPixel ? "border-[#a3e635] bg-[#a3e635]/10" : "border-[rgba(248,247,244,0.15)] bg-white/5"
                        }`}
                        id="cookie-toggle-meta"
                      >
                        <span className={`w-4 h-4 bg-[#F8F7F4] transition-all block ${
                          prefs.metaPixel ? "translate-x-6 bg-[#a3e635]" : "translate-x-0 bg-gray-500"
                        }`} />
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-[rgba(248,247,244,0.1)]">
                  ...
                  <div className="flex gap-2 w-full sm:w-auto justify-end">
                    <button
                      onClick={handleRejectAll}
                      className="flex-1 sm:flex-initial px-4 py-2 border border-[rgba(248,247,244,0.15)] hover:border-[#a3e635] text-xs font-mono font-bold uppercase tracking-wider text-[#F8F7F4]/70 hover:text-[#a3e635] transition-all cursor-pointer"
                    >
                      {lang === "it" ? "Rifiuta Tutti" : "Reject All"}
                    </button>
                    <button
                      onClick={handleSaveCustom}
                      className="flex-1 sm:flex-initial px-5 py-2 bg-transparent hover:bg-[#a3e635] text-[#a3e635] hover:text-[#111113] border border-[#a3e635] text-xs font-mono font-bold uppercase tracking-wider transition-all cursor-pointer"
                    ...
                    <button
                      onClick={handleAcceptAll}
                      className="flex-1 sm:flex-initial px-5 py-2 bg-[#a3e635] text-[#111113] text-xs font-mono font-bold uppercase tracking-wider hover:bg-transparent hover:text-[#a3e635] border border-[#a3e635] transition-all cursor-pointer"
                    >
                      {lang === "it" ? "Accetta Tutti" : "Accept All"}
                    </button>
                  </div>
