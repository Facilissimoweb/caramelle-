  ...
  const contentMap = {
    it: {
      privacy: {
        ...
        icon: <ShieldAlert className="w-8 h-8 text-[#a3e635]" />,
        normal: (
        ...
        facilitated: (
          <div className="space-y-6 text-base text-[#F8F7F4] leading-relaxed font-sans">
            <p className="bg-[#151518] p-4 border-l-4 border-[#a3e635] text-sm">
      ...
      terms: {
        ...
        icon: <FileText className="w-8 h-8 text-[#a3e635]" />,
        normal: (
          <div className="space-y-6 text-sm text-[#F8F7F4]/85 leading-relaxed font-sans">
      ...
      ethics: {
        ...
        icon: <Sparkles className="w-8 h-8 text-[#a3e635]" />,
        normal: (
          <div className="space-y-6 text-sm text-[#F8F7F4]/85 leading-relaxed font-sans">
            ...
            <div className="bg-[#a3e635]/10 border border-[#a3e635]/30 p-4 text-[#F8F7F4] font-sans my-4">
      ...
      sitemap: {
        ...
        icon: <Compass className="w-8 h-8 text-[#a3e635]" />,
        normal: (
          <div className="space-y-6 text-sm text-[#F8F7F4]/85 leading-relaxed font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-[#111113]/50 p-4 border border-[rgba(248,247,244,0.08)]">
              <div className="space-y-2">
                <h4 className="font-display font-bold text-xs uppercase tracking-wider text-[#a3e635]">1. Navigazione Principale</h4>
              ...
              <div className="space-y-2">
                <h4 className="font-display font-bold text-xs uppercase tracking-wider text-[#a3e635]">2. Moduli ed Utility</h4>
                <ul className="space-y-1.5 pl-3 border-l border-[rgba(248,247,244,0.15)] text-[11px] font-mono">
        ...
        facilitated: (
          <div className="space-y-6 text-base text-[#F8F7F4] leading-relaxed font-sans">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-[#a3e635]">Pagine principali che puoi visitare:</h4>
      ...
      sitemap: {
        ...
        normal: (
          <div className="space-y-6 text-sm text-[#F8F7F4]/85 leading-relaxed font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-[#111113]/50 p-4 border border-[rgba(248,247,244,0.08)]">
              <div className="space-y-2">
                <h4 className="font-display font-bold text-xs uppercase tracking-wider text-[#a3e635]">1. Core Navigation</h4>
                <ul className="space-y-1.5 pl-3 border-l border-[rgba(248,247,244,0.15)] text-[11px] font-mono">
              ...
              <div className="space-y-2">
                <h4 className="font-display font-bold text-xs uppercase tracking-wider text-[#a3e635]">2. Modality &amp; Preferences</h4>
                <ul className="space-y-1.5 pl-3 border-l border-[rgba(248,247,244,0.15)] text-[11px] font-mono">
        ...
        facilitated: (
          <div className="space-y-6 text-base text-[#F8F7F4] leading-relaxed font-sans">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-[#a3e635]">Main pages you can explore:</h4>
                <ul className="list-disc pl-5 mt-2 space-y-1.5 text-sm">
        ...
        >
          ...
          <div className="flex items-center justify-between gap-4 border-b border-[rgba(248,247,244,0.1)] pb-5 mb-6 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleSpeak}
                className="p-2 border border-[rgba(248,247,244,0.1)] hover:border-[#a3e635] text-[#F8F7F4]/70 hover:text-[#a3e635] transition-all flex items-center gap-1.5 cursor-pointer text-xs font-mono"
                title={lang === "it" ? "Leggi ad alta voce" : "Read aloud"}
                id="btn-speak-text"
              >
                {isPlaying ? <VolumeX className="w-4 h-4 text-[#a3e635]" /> : <Volume2 className="w-4 h-4" />}
