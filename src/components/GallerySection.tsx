              ...
              <button
                ...
                className={`px-3 py-1.5 font-mono text-[9px] uppercase tracking-wider border transition-all cursor-pointer ${
                  selectedCategory === cat
                    ? "bg-white text-[#111113] border-white font-bold"
            ...
            return (
              <div
                ...
                className={`group bg-[#151518] border transition-all duration-300 flex flex-col relative ${
                  isDragging === item.id 
                    ? "border-white scale-[0.99] bg-[#1a1a1e]" 
                    : "border-[rgba(248,247,244,0.1)] hover:border-white/40"
                }`}
              ...
              >
                ...
                <div className="aspect-[16/10] overflow-hidden relative bg-[#0f0f11] border-b border-[rgba(248,247,244,0.08)]">
                  ...
                  {isDragging === item.id && (
                    <div className="absolute inset-0 bg-[#111113]/90 flex flex-col items-center justify-center text-white z-20 animate-fade-in">
                  ...
                  <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-10">
                    <span className="bg-[#111113]/80 backdrop-blur-md text-white px-2.5 py-1 text-[8px] font-mono tracking-widest uppercase font-bold border border-white/30">
                      {item.category}
                    </span>
                    ...
                    <div className="flex gap-2">
                      {isCustom ? (
                        <span className="bg-white text-[#111113] px-2 py-0.5 text-[8px] font-mono tracking-wider font-bold rounded-sm flex items-center gap-1">
                  ...
                  <div className="absolute bottom-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                    ...
                    <button
                      ...
                      className="p-1.5 bg-[#111113]/90 text-white hover:text-[#F8F7F4] border border-white/30 hover:bg-white/20 transition-colors rounded cursor-pointer"
                    >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <h3 className="font-display text-base font-bold text-[#F8F7F4] group-hover:text-white transition-colors">
                      {item.title}
                    </h3>
        ...
        {lightboxItem && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setLightboxItem(null)}
                className="absolute top-4 right-4 z-10 p-2 bg-[#111113]/80 hover:bg-white text-[#F8F7F4] hover:text-[#111113] transition-colors border border-[rgba(248,247,244,0.1)] rounded-full cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="p-6 border-t border-[rgba(248,247,244,0.1)] bg-[#111113] space-y-4">
                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                  ...
                  <div className="text-right sm:text-right text-left font-mono text-[10px] text-[#F8F7F4]/50 space-y-1">
                    ...
                    <div>{lang === "it" ? "Percorso asset" : "Asset path"}: <code className="bg-[#151518] px-1 py-0.5 text-white/80">/public/assets/images/{lightboxItem.filename}</code></div>
                  </div>
                </div>
                ...
                <div className="pt-2 flex justify-end gap-3 border-t border-[rgba(248,247,244,0.06)]">
                  <button
                    ...
                    className="px-4 py-2 border border-white/30 hover:border-white text-white font-mono text-[9px] uppercase tracking-wider font-bold transition-all cursor-pointer bg-[#151518]"
                  >
