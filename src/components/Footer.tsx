...
export default function Footer({
  ...
  return (
    <footer 
      ref={footerRef}
      className="relative w-full border-t border-white/10 pt-16 pb-12 transition-all text-white overflow-hidden bg-[#000000]" 
    >
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <nav aria-label={lang === "it" ? "Navigazione piè di pagina" : "Footer navigation"} className="md:col-span-3 space-y-4 order-1">
        ...
        {/* Support & Philosophy */}
        <div className="md:col-span-4 space-y-5 order-2">
        ...
        <div className="md:col-span-5 space-y-5 order-3">
          ...
          <div className="pt-2 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              ...
              {/* Visa */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-[#17171c] border border-white/10 hover:border-[#1A1F71]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
              ...
              {/* Mastercard */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-[#17171c] border border-white/10 hover:border-[#FF5F00]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
              ...
              {/* Bonifico SEPA */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-[#17171c] border border-white/10 hover:border-white/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
