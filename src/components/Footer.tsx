        ...
        <div className="md:col-span-5 space-y-4">
          ...
          <div className="pt-4 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              ...
              {/* Bonifico SEPA */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-[#17171c] border border-white/10 hover:border-[#a3e635]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
            ...
            {[
              ...
              <li key={link.id}>
                <button
                  ...
                  className="text-white/70 hover:text-[#a3e635] hover:underline cursor-pointer transition-colors text-left font-bold"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div className="md:col-span-4 space-y-4">
          ...
          <div className="flex flex-col gap-2.5 pt-2">
            <a
              ...
              className="flex items-center gap-2.5 text-xs text-white hover:text-[#a3e635] transition-all border border-white/15 hover:border-[#a3e635] px-3.5 py-2.5 rounded-none w-fit font-bold"
              title="Invia Email"
            >
          ...
          <div className="pt-6 border-t border-white/10 mt-6 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 text-[10px] text-white hover:text-[#a3e635] transition-all bg-[#17171c] border border-white/10 hover:border-[#a3e635] px-3.5 py-2 cursor-pointer uppercase font-mono font-bold"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 mt-12 pt-8 border-t border-white/10 flex flex-col lg:flex-row justify-between items-center gap-6 text-xs text-white/50 font-mono">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 uppercase tracking-wider text-xs md:text-sm">
          <button
            ...
            className="hover:text-[#a3e635] transition-colors cursor-pointer bg-transparent border-none p-0 text-xs md:text-sm uppercase tracking-wider font-mono font-bold text-white/70"
        ...
        <button
          ...
          className="flex items-center gap-1.5 hover:text-[#a3e635] transition-colors font-mono tracking-widest cursor-pointer uppercase text-xs font-bold shrink-0 text-white"
          id="scroll-to-top"
        >
          <span>Torna su</span>
