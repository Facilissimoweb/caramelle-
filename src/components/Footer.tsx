...
export default function Footer({
  ...
  return (
    <footer 
      ref={footerRef}
      className="relative w-full border-t border-white/10 pt-16 pb-12 transition-all text-white overflow-hidden bg-[#624369]" 
      style={{ backgroundColor: "#624369" }}
    >
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-5 space-y-5 order-1">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-display text-xl font-bold italic text-white tracking-tight">
              Facilissimo Web
            </span>
          </div>
          ...
          <div className="pt-2 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              {/* Stripe */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-black/25 border border-white/10 hover:border-[#635BFF]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
              ...
              {/* Visa */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-black/25 border border-white/10 hover:border-[#1A1F71]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
              ...
              {/* Mastercard */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-black/25 border border-white/10 hover:border-[#FF5F00]/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
              ...
              {/* Bonifico SEPA */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-black/25 border border-white/10 hover:border-white/50 transition-all rounded-md text-[10px] font-sans font-medium text-white/90 cursor-default select-none">
                <svg className="h-4 w-auto text-white fill-current shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <nav aria-label={lang === "it" ? "Navigazione piè di pagina" : "Footer navigation"} className="md:col-span-3 space-y-4 order-2">
          ...
          <ul className="space-y-3 text-xs font-mono uppercase tracking-wider">
            {[
              ...
              { id: "chiavi-in-mano", label: lang === "it" ? "Sito & Abbonamento" : "Turnkey & Subscription" },
        ...
        <div className="md:col-span-4 space-y-5 order-3">
          ...
          <div className="flex flex-col gap-2.5 pt-1">
            <a
              ...
              className="flex items-center gap-2.5 text-xs text-white hover:text-white transition-all border border-white/20 hover:border-white px-3.5 py-3 rounded-none w-full sm:w-fit font-bold bg-black/25 hover:bg-black/40"
              title="Invia Email"
            >
          ...
          <div className="pt-5 border-t border-white/10 mt-5 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 text-[10px] text-white hover:text-white transition-all bg-black/25 border border-white/20 hover:border-white px-3.5 py-2.5 cursor-pointer uppercase font-mono font-bold"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 mt-12 pt-8 border-t border-white/10 flex flex-col lg:flex-row justify-between items-center gap-6 text-xs text-white/50 font-mono">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 uppercase tracking-wider text-xs md:text-sm">
          <button
            ...
            className="hover:text-white transition-colors cursor-pointer bg-transparent border-none p-0 text-xs md:text-sm uppercase tracking-wider font-mono font-bold text-white/70"
        ...
        <button
          ...
          className="flex items-center gap-1.5 hover:text-white transition-colors font-mono tracking-widest cursor-pointer uppercase text-xs font-bold shrink-0 text-white"
          id="scroll-to-top"
        >
          <span>Torna su</span>
