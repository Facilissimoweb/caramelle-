...
export default function Footer({
  ...
  return (
    <footer className="w-full border-t border-[#111113]/10 pt-16 pb-12 transition-all text-[#111113]" style={{ backgroundColor: "#c99e97" }}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-5 space-y-4">
          <div className="flex items-center gap-3">
            <img
              ...
              className="w-12 h-12 object-contain rounded-full border border-[#111113]/10"
            />
            <span className="font-display text-xl font-bold italic text-[#111113] tracking-tight">
              Facilissimo Web
            </span>
          </div>
          <p className="text-xs sm:text-sm text-[#111113]/85 max-w-sm leading-relaxed font-sans">
          ...
          <div className="pt-2 text-[10px] text-[#544848] font-mono space-y-1 uppercase tracking-wider font-bold">
            <p>Titolare: M. Teresa Rogani</p>
            <p>Freelance Web Designer &amp; AI Specialist</p>
            <p className="text-[#111113]/70 flex items-center gap-1.5 normal-case font-sans">
              <MapPin className="w-3.5 h-3.5 text-[#544848]" /> Macerata (Marche), Italia
            </p>
            <p className="text-[#111113]/55 font-normal">P.IVA: 02136780430</p>
          </div>
          
          <p className="text-[10px] text-[#111113]/60 leading-relaxed font-sans italic border-t border-[#111113]/10 pt-3 mt-3">
            {lang === "it"
          ...
          <div className="pt-4 space-y-2.5">
            <span className="text-[9px] font-mono tracking-[0.2em] text-[#111113]/50 uppercase block">
              {lang === "it" ? "METODI DI PAGAMENTO SICURI" : "SECURE PAYMENT METHODS"}
            </span>
            <div className="flex flex-wrap gap-2 pt-1">
              {/* Stripe */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/30 border border-[#111113]/15 hover:border-[#635BFF]/50 transition-all rounded-md text-[10px] font-sans font-medium text-[#111113] cursor-default select-none">
              ...
              {/* Visa */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/30 border border-[#111113]/15 hover:border-[#1A1F71]/50 transition-all rounded-md text-[10px] font-sans font-medium text-[#111113] cursor-default select-none">
              ...
              {/* Mastercard */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/30 border border-[#111113]/15 hover:border-[#FF5F00]/50 transition-all rounded-md text-[10px] font-sans font-medium text-[#111113] cursor-default select-none">
              ...
              {/* Bonifico SEPA */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/30 border border-[#111113]/15 hover:border-[#544848]/50 transition-all rounded-md text-[10px] font-sans font-medium text-[#111113] cursor-default select-none">
                <svg className="h-4 w-auto text-[#544848] fill-current shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="md:col-span-3">
          <h4 className="text-[10px] uppercase tracking-widest text-[#544848] font-bold mb-4 font-mono">
            Menu Sito
          </h4>
            ...
            {[
              ...
              <li key={link.id}>
                <button
                  ...
                  className="text-[#111113]/75 hover:text-[#111113] hover:underline cursor-pointer transition-colors text-left font-bold"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div className="md:col-span-4 space-y-4">
          <h4 className="text-[10px] uppercase tracking-widest text-[#544848] font-bold mb-1 font-mono">
            Contatto Diretto
          </h4>
          <p className="text-xs sm:text-sm text-[#111113]/85 leading-relaxed font-sans">
          ...
          <div className="flex flex-col gap-2.5 pt-2">
            <a
              ...
              className="flex items-center gap-2.5 text-xs text-[#111113] hover:text-[#544848] transition-all border border-[#111113]/20 hover:border-[#544848] px-3.5 py-2.5 rounded-none w-fit font-bold"
              title="Invia Email"
            >
              <Mail className="w-4 h-4 text-[#544848]" />
            ...
            >
              <Phone className="w-4 h-4 text-[#544848]" />
              <span className="font-medium font-mono">+39 379 360 3321</span>
            </a>
          </div>

          {/* Dynamic Page Sharing Section inside Footer */}
          <div className="pt-6 border-t border-[#111113]/10 mt-6 space-y-3">
            <h5 className="text-[9px] uppercase tracking-[0.2em] text-[#111113]/50 font-bold font-mono">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 text-[10px] text-[#111113] hover:text-[#544848] transition-all bg-white/30 border border-[#111113]/15 hover:border-[#544848] px-3.5 py-2 cursor-pointer uppercase font-mono font-bold"
                id="footer-share-action-btn"
              >
                <Share2 className="w-3.5 h-3.5 text-[#544848]" />
                <span>
              ...
              >
                {copiedLink ? (
                  ...
                  <>
                    <Copy className="w-3.5 h-3.5 text-[#544848]" />
            ...
            <p className="text-[9px] text-[#111113]/50 font-mono italic">
              {lang === "it" 
      ...
      {/* Under Footer */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-12 pt-8 border-t border-[#111113]/10 flex flex-col lg:flex-row justify-between items-center gap-6 text-xs text-[#111113]/60 font-mono">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 uppercase tracking-wider text-xs md:text-sm">
          <button
            ...
            className="hover:text-[#111113] transition-colors cursor-pointer bg-transparent border-none p-0 text-xs md:text-sm uppercase tracking-wider font-mono font-bold"
        ...
        <button
          ...
          className="flex items-center gap-1.5 hover:text-[#111113] transition-colors font-mono tracking-widest cursor-pointer uppercase text-xs font-bold shrink-0 text-[#111113]"
          id="scroll-to-top"
        >
          <span>Torna su</span>
          <ArrowUp className="w-3.5 h-3.5 text-[#544848]" />
        </button>
      </div>
    </footer>
  );
