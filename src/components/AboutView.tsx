  ...
  const formationSteps = [
    {
      ...
      desc: "Principi fondamentali del design e della comunicazione visiva: tipografia, teoria della percezione, griglie compositive e gerarchia dell'informazione per realizzare layout essenziali, performanti ed ergonomici.",
    },
    {
      num: "02",
      ...
      desc: "Approfondimento universitario nei linguaggi visivi per analizzare la percezione, la teoria del colore e il ritmo sequenziale, applicandoli al web design per percorsi di navigazione coerenti ed efficaci.",
    },
    {
      num: "03",
      title: "Logica Concettuale e Analisi del Linguaggio",
      subtitle: "Percorso Universitario in Filosofia Classica — Università di Macerata",
      icon: <BookOpen className="w-5 h-5 text-black" />,
      desc: "Studio della struttura del pensiero, della logica e dell'analisi del linguaggio. Un bagaglio analitico che si traduce nell'ascolto dei bisogni del committente e in un'architettura dell'informazione limpida.",
    },
    {
      num: "04",
      title: "Spazialità e Materialità dell'Interfaccia",
      subtitle: "Percorso Formativo in Scultura Contemporanea — Accademia di Belle Arti",
      icon: <Layers className="w-5 h-5 text-black" />,
      desc: "Ricerca artistica incentrata sulla consapevolezza dello spazio, della materia e dell'interazione, che guida la progettazione delle interfacce web come veri e propri spazi di esperienza e presenza per l'utente.",
    },
  ];
  ...
  const valuesGuida = [
    {
      ...
      icon: <Award className="w-5 h-5 text-black" />,
      desc: "Dalla tipografia alle griglie compositive, ogni elemento risponde a regole di gerarchia ed ergonomia visiva per eliminare il superfluo e valorizzare l'essenziale.",
    },
    {
      num: "2",
      title: "Architettura del Pensiero e Ascolto",
      icon: <Cpu className="w-5 h-5 text-black" />,
      desc: "Logica concettuale e ascolto analitico per decomporre le esigenze del committente e tradurle in un'architettura dell'informazione limpida e coerente.",
    },
    {
      num: "3",
      title: "Sistema d'Immagine Narrativo",
      icon: <Compass className="w-5 h-5 text-black" />,
      desc: "Gestione del colore, del ritmo e della sequenza visiva per guidare l'utente nell'esperienza digitale in modo fluido, naturale ed efficace.",
    },
    {
      num: "4",
      title: "Presenza e Dimensione Umana",
      icon: <UserCheck className="w-5 h-5 text-black" />,
      desc: "Consapevolezza dello spazio e della percezione per creare interfacce digitali progettate al servizio delle persone e dell'esperienza reale.",
    },
  ];
