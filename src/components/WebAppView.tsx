...
export default function WebAppView({ setCurrentTab, lang, isFacilitated }: WebAppViewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#111113] text-[#F8F7F4] relative selection:bg-[#E35930]/20">
      ...
      <section className="py-20 bg-[#111113]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-end gap-6 mb-16 border-b border-[rgba(248,247,244,0.06)] pb-10">
            <div className="max-w-2xl space-y-3">
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-wide text-[#F8F7F4]">
            ...
            <button
              ...
              className="text-[#E35930] hover:text-[#F8F7F4] font-mono text-[10px] font-bold tracking-widest uppercase flex items-center gap-1.5 transition-all group cursor-pointer border border-[#E35930]/30 hover:border-[#E35930] px-5 py-3 rounded-none bg-transparent"
