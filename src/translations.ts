export interface TranslationSet {
  ...
  navWebApp: string;
  navSitiWeb: string;
  navAbbonamento: string;
  navChiaviInMano: string;
  navChiSono: string;
  navContatti: string;
  navChat: string;
  navBlog: string;
...
export const translations: Record<"it" | "en", { normal: TranslationSet; facilitated: TranslationSet }> = {
  it: {
    normal: {
      ...
      navWebApp: "Proposte",
      navSitiWeb: "Proposte",
      navAbbonamento: "Sito & Abbonamento",
      navChiaviInMano: "Sito & Abbonamento",
      navChiSono: "Chi Sono",
  ...
  en: {
    normal: {
      ...
      navAbbonamento: "Turnkey & Subscription",
      navChiaviInMano: "Turnkey & Subscription",
      navChiSono: "About",
      navContatti: "Contact",
      navChat: "AI Chat",
      navBlog: "Blog & News",
