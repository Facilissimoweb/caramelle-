...
export const translations: Record<"it" | "en", { normal: TranslationSet; facilitated: TranslationSet }> = {
  it: {
    ...
    facilitated: {
      ...
      portfolioDesc: "Ecco alcuni siti internet che ho realizzato per i miei clienti con passione e cura.",
      ...
      ctaTitle: "Facciamo crescere la tua attività.",
      ctaDesc: "Scrivimi per parlarmi della tua idea. Creiamo insieme un sito internet eccezionale e facile da usare.",
      ctaBtnPrimary: "Parliamo del tuo progetto",
      ctaBtnSecondary: "Parla con il mio Assistente AI",
    },
  },
  en: {
    normal: {
    ...
    facilitated: {
      ...
      portfolioPre: "[ RECENT WORKS ]",
      portfolioTitle: "Websites I Made",
      portfolioDesc: "Here are some websites I have created for my clients with passion and care.",
      ...
      ctaDesc: "Send me a message to talk about your idea. We will create an amazing website together that is very easy to use.",
      ctaBtnPrimary: "Let's talk about your project",
      ctaBtnSecondary: "Talk with my smart AI Helper",
    },
  },
};
